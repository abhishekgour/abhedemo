...
//    return [self loadAndActivateImageTrackerDataSet:@"techvalensdemo.xml"];
...
//
    return [self loadAndActivateImageTrackerDataSet:zipSetPathNew1];
//    fffff
}
...
//            NSArray *zipPath = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//            NSString *zipDocumentDirectory = [zipPath objectAtIndex:0];
//            if(dataSet->exists([zipDocumentDirectory cStringUsingEncoding:NSASCIIStringEncoding], QCAR::DataSet::STORAGE_APPRESOURCE))
//            {
//                NSLog(@"file exists");
//            }
//            if(dataSet->exists([@"techvalensdemo.xml" cStringUsingEncoding:NSASCIIStringEncoding], QCAR::DataSet::STORAGE_APPRESOURCE))
//            {
//                NSLog(@"file exists");
//            }
